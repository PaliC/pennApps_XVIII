...
const app = express()
    ...
    , clientID = process.env.DS_CLIENT_ID || '681b9e43-d36e-48b5-aa2a-bd1abe8ceaba'
    , clientSecret = process.env.DS_CLIENT_SECRET || '7d236c96-4064-4730-92bc-d32a03571b87'
    , signerEmail = process.env.DS_SIGNER_EMAIL || 'lhussain@princeton.edu'
    , signerName = process.env.DS_SIGNER_NAME || '{USER_NAME}'
    , templateId = process.env.DS_TEMPLATE_ID || '2b29c035-049c-437b-802d-befeacf762bc'
