...
const app = express()
    ...
    , clientID = process.env.DS_CLIENT_ID || '2de9cead-8310-492c-9b2f-c55a523933f9'
    , clientSecret = process.env.DS_CLIENT_SECRET || 'df3ee6d1-9562-4a0d-9bd3-b7516f836d90'
    , signerEmail = process.env.DS_SIGNER_EMAIL || 'lhussain@princeton.edu'
    , signerName = process.env.DS_SIGNER_NAME || '97a76b19-e6e9-486a-b85a-2db8ae10d10c'
